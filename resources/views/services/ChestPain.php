...
@section('content')
        ...
        <div class="page-nav row">
            <div class="container">
                <div class="row">
                    <h2><font color="#663399"; size="28px">Viral Fever</font></h2>
                    ...
                    <ul>
                        ...
                        <li><i class="fas fa-angle-double-right"></i> <font size="4px">Viral Fever</font> </li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <img src="{{asset('assets/images/facilities/Viral-fever.jpg')}}" alt="" height=510">
                        <p style="text-align:center; font-size:40px"><font color="purple"><u>Viral Fever</u></font></p>
                        ...
                        <font size="5px" ; color="#C71585">Overview</font> 
                                <p style="text-align : justify; font-size:16px;">A normal body temperature is approximately 98.6 °F, but may fluctuate depending on the time of day or what temperature reading method was used. While any temperature above your normal temperature range is considered a fever, there are different levels of fever severity.</p>
                                 </br>
...
<li>&nbsp&nbsp&nbsp 1.Overheating</li>

<li>&nbsp&nbsp&nbsp 2.Sweating</li>

<li>&nbsp&nbsp&nbsp 3.Chills</li>

<li>&nbsp&nbsp&nbsp 4.Discomfort</li>

<li>&nbsp&nbsp&nbsp 5.Achy muscles</li>

<li>&nbsp&nbsp&nbsp 6.Rash</li>

<li>&nbsp&nbsp&nbsp 7.Restlessness or Sleeplessness</li>

<li>&nbsp&nbsp&nbsp 8.Headache</li>

<li>&nbsp&nbsp&nbsp 9.Weakness</li>

<li>&nbsp&nbsp&nbsp 10.Decreased appetite</li>

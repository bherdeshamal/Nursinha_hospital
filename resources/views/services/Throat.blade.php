...
@section('content')
        ...
        <div class="page-nav row">
            <div class="container">
                <div class="row">
                    <h2><font color="#663399"; size="28px">Throat Pain</font></h2>
                    ...
                    <ul>
                        ...
                        <li><i class="fas fa-angle-double-right"></i> <font size="4px">Throat Pain</font> </li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <img src="{{asset('assets/images/facilities/Throat-pain.jpg')}}" alt="" height=510">
                        <p style="text-align:center; font-size:40px"><font color="purple"><u>Throat Pain</u></font></p>
                        ...
                        <font size="5px" ; color="#C71585">Overview</font> 
                                <p style="text-align : justify; font-size:16px;">A sore throat is pain, scratchiness or irritation of the throat that often worsens when you swallow. The most common cause of a sore throat (pharyngitis) is a viral infection, such as a cold or the flu. A sore throat caused by a virus resolves on its own.
</p>
                                 </br>
                                 <p style="text-align : justify; font-size:16px;">Strep throat (streptococcal infection), a less common type of sore throat caused by bacteria, requires treatment with antibiotics to prevent complications. Other less common causes of sore throat might require more complex treatment.</p>

                                 </br>
                                
            <font size="5px" ; color="#C71585">Symptoms </font> 
</br>
            <p style="text-align :justify; font-size:16px;"> Symptoms of a sore throat can vary depending on the cause. Signs and symptoms might include:</p>
                </br> 
                <p style="text-align :justify; font-size:16px;">Pain or a scratchy sensation in the throat</p>
       </br>
       <p style="text-align :justify; font-size:16px;">Pain that worsens with swallowing or talking</P>
</BR>
<p style="text-align :justify; font-size:16px;">Difficulty swallowing</P>
</br>
<p style="text-align :justify; font-size:16px;">Sore, swollen glands in your neck or jaw</P>
</br>
                  <font size="5px" ; color="#C71585">Causes</font> 
                        </br>
                        <p style="text-align :justify; font-size:16px;"> Viruses that cause the common cold and the flu also cause most sore throats. Less often, bacterial infections cause sore throats.</p>
            
                            
                </br>
                <p style="text-align :justify; font-size:16px;"><b>Viral Infections</b> Viral illnesses that cause a sore throat include:
...
Croup — a common childhood illness characterized by a harsh, barking cough
                ...
                <p style="text-align :justify; font-size:16px;"><b>Bacterial Infections</b> Many bacterial infections can cause a sore throat. The most common is Streptococcus pyogenes (group A streptococcus) which causes strep throat.
</p>

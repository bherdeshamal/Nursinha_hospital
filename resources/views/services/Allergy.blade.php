...
@section('content')
        ...
        <div class="page-nav row">
            <div class="container">
                <div class="row">
                    <h2><font color="#663399"; size="28px">Allergy</font></h2>
                    ...
                    <ul>
                        ...
                        <li><i class="fas fa-angle-double-right"></i> <font size="4px">Allergy</font> </li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <img src="{{asset('assets/images/facilities/Allergy.jpg')}}" alt="" height="510">
                        <p style="text-align:center; font-size:40px"><font color="purple"><u>Allergy</u></font></p>
                        ...
                        <font size="5px" ; color="#C71585">Overview</font> 
                                <p style="text-align : justify; font-size:16px;">Allergies are among the most common chronic conditions worldwide. Allergy symptoms range from making you miserable to putting you at risk for life-threatening reactions.</p>
                                </br>
                                <p style="text-align : justify; font-size:16px;">According to the leading experts in allergy, an allergic reaction begins in the immune system. Our immune system protects us from invading organisms that can cause illness. If you have an allergy, your immune system mistakes an otherwise harmless substance as an invader. This substance is called an allergen. The immune system overreacts to the allergen by producing Immunoglobulin E (IgE) antibodies. These antibodies travel to cells that release histamine and other chemicals, causing an allergic reaction.</p>
                        </br>
                        <font size="5px" ; color="#C71585">Allergy Symptoms</font> 
                        <p style="text-align :justify; font-size:16px;">An allergic reaction typically triggers symptoms in the nose, lungs, throat, sinuses, ears, lining of the stomach or on the skin. For some people, allergies can also trigger symptoms of asthma. In the most serious cases, a life-threatening reaction called anaphylaxis (an-a-fi-LAK-sis) can occur.</p> 
                        </br>

                        
                <p style="text-align :justify; font-size:16px;">A number of different allergens are responsible for allergic reactions. The most common include:</p>
            </br>
                <ol>
                     <ul>
                         <li>&nbsp&nbsp&nbsp 1. Pollen</li>
                         <li>&nbsp&nbsp&nbsp 2. Dust</li>
                         <li>&nbsp&nbsp&nbsp 3. Food</li>
                         <li>&nbsp&nbsp&nbsp 4. Insect Stings</li>
                         <li>&nbsp&nbsp&nbsp 5. Animal Dander</li>
                         <li>&nbsp&nbsp&nbsp 6. Mold</li>
                         <li>&nbsp&nbsp&nbsp 7. Medications</li>
                         <li>&nbsp&nbsp&nbsp 8. Latex</li>
                     </ul>
                ...
                <font size="5px" ; color="#C71585">Allergy Diagnosis</font> 
                 <p style="text-align :justify; font-size:16px;">If you or your child have allergy symptoms, an allergist/immunologist, often referred to as an allergist, can help with a diagnosis. An allergist has advanced training and experience to properly diagnose your condition and prescribes an allergy treatment and management plan to help you feel better and live better.</p> 
                    </br> </br>

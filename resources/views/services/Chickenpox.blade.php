...
@section('content')
        ...
        <div class="page-nav row">
            <div class="container">
                <div class="row">
                    <h2><font color="#663399"; size="28px">Chickenpox</font></h2>
                    ...
                    <ul>
                        ...
                        <li><i class="fas fa-angle-double-right"></i> <font size="4px">Chickenpox</font> </li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <img src="{{asset('assets/images/facilities/Chickenpox.jfif')}}" alt="" height="510">
                        <p style="text-align:center; font-size:40px"><font color="purple"><u>Chickenpox</u></font></p>
                        ...
                        <font size="5px" ; color="#C71585">Overview</font> 
                                <p style="text-align : justify; font-size:16px;">Chikungunya (CHIKV) is a crippling viral disease transmitted by an aggressive species of mosquito that leaves its victims with arthritis. The disease gets its name from an African verb ‘to become contorted’, which explains the contorted posture of its sufferers. The first was first discovered in 1952 in Africa after an outbreak on the Makonde Plateau. The virus likely originated in Central/East Africa, where the virus was found circulating in a sylvatic cycle between forest-dwelling mosquitoes and nonhuman primates.</p>
                                </br>

                        <font size="5px" ; color="#C71585">What are the symptoms of Chikungunya?</font> 
                        <p style="text-align :justify; font-size:16px;">The symptoms of Chikungunya starts showing up within seven days after infection and ends up lasting for up to several weeks.</p> 
                        </br>
                        <ol>
                            <ul>
                            <li>&nbsp&nbsp&nbsp 1. High fever</li>
                            <li>&nbsp&nbsp&nbsp 2. Joint Pain</li>
                            <li>&nbsp&nbsp&nbsp 3. Headache </li>
                            <li>&nbsp&nbsp&nbsp 4. Nausea </li>
                            <li>&nbsp&nbsp&nbsp 5. Fatigue</li>
                            </ul>
                        </ol>
                        </br>

                        <font size="5px" ; color="#C71585">What causes Chikungunya?</font> 
                        
                <p style="text-align :justify; font-size:16px;">Female mosquitoes catch Chikungunya virus from infected humans and pass it on to the next human victim. In Australia, the Aedes aegypti is a domesticated mosquito located in Queensland and a vector for the Chikungunya virus. The preferred hiding place of the mosquito is dark spaces inside your house and it is active during daytime.</p>
            </br>
                        <font size="5px" ; color="#C71585">How do you prevent Chikungunya?</font> 
                        
                <p style="text-align :justify; font-size:16px;">With no vaccine available for Chikungunya, mosquito control is the best form of protection. These below mentioned mosquito control tips will help you safeguard your home and family.</p>
         
                </br>
                <ol>
                            <ul>
                            <li>&nbsp&nbsp&nbsp 1. Wear clothing that covers all your body parts</li>
                            <li>&nbsp&nbsp&nbsp 2. Regularly apply a skin insect repellent</li>
                            <li>&nbsp&nbsp&nbsp 3. Refrain from wearing too much perfume or aftershave </li>
                            <li>&nbsp&nbsp&nbsp 4. Whenever possible, close windows and window screens </li>
                            <li>&nbsp&nbsp&nbsp 5. Get rid of water containers that act as breeding grounds</li>
                            </ul>
                        </ol>
                       </br>
                    
                       <font size="5px" ; color="#C71585">How do you treat Chikungunya?</font> 
                                <p style="text-align : justify; font-size:16px;">If you come across symptoms after your travel to endemic regions, get medical advice immediately. There is no exact cure, but right treatment helps in treating symptoms like joint pain.</p>
                                </br>

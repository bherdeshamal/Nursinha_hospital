            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <img src="{{asset('assets/images/facilities/nebulizer.jpg')}}" alt="" height=510">
                        ...
                        <font size="5px" ; color="#C71585">Overview</font> 
                                <p style="text-align : justify; font-size:16px;">A nebulizer is a drug delivery device used to administer medication in the form of a mist inhaled into the lungs. Nebulizers are commonly used for the treatment of cystic fibrosis, asthma, COPD and other respiratory diseases or disorders. Analytical nebulizers are another form of the nebulizer and are used primarily in laboratory settings for elemental analysis. Nebulizers use oxygen, compressed air or ultrasonic power to break up solutions and suspensions into small aerosol droplets that can be directly inhaled from the mouthpiece of the device. An aerosol is a mixture of gas and solid or liquid particles.</p>
                                 </br>

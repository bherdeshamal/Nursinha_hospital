...
@section('content')
        ...
        <div class="page-nav row">
            <div class="container">
                <div class="row">
                    <h2><font color="#663399"; size="28px">BloodTest</font></h2>
                    ...
                    <ul>
                        ...
                        <li><i class="fas fa-angle-double-right"></i> <font size="4px">BloodTest</font> </li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <img src="{{asset('assets/images/facilities/BloodTest.jpg')}}" alt="" height=510">
                        <p style="text-align:center; font-size:40px"><font color="purple"><u>BloodTest</u></font></p>
                        ...
                        <font size="5px" ; color="#C71585">Overview</font> 
                                <p style="text-align : justify; font-size:16px;">A complete blood count (CBC) is a blood test used to evaluate your overall health and detect a wide range of disorders, including anemia, infection and leukemia.</p>
                                </br>
                                <p style="text-align : justify; font-size:16px;">A complete blood count test measures several components and features of your blood, including:</P>
            </br>

                        <p style="text-align :justify; font-size:16px;">Red blood cells, which carry oxygen</p> 
                        </br>
                        <p style="text-align :justify; font-size:16px;">White blood cells, which fight infection</p> 
                        </br>
                        <p style="text-align :justify; font-size:16px;">Hemoglobin, the oxygen-carrying protein in red blood cells</p> 
                        </br>
                      <p style="text-align :justify; font-size:16px;">Hematocrit, the proportion of red blood cells to the fluid component, or plasma, in your blood</p> 
                </br>

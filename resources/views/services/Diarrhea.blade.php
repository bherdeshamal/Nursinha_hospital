...
@section('content')
        ...
        <div class="page-nav row">
            <div class="container">
                <div class="row">
                    <h2><font color="#663399"; size="28px">Diarrhea</font></h2>
                    ...
                    <ul>
                        ...
                        <li><i class="fas fa-angle-double-right"></i> <font size="4px">Diarrhea</font> </li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <img src="{{asset('assets/images/facilities/Diarrhea.jpg')}}" alt="" height="510">
                        <p style="text-align:center; font-size:40px"><font color="purple"><u>Diarrhea</u></font></p>

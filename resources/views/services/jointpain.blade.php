...
@section('content')
        ...
        <div class="page-nav row">
            <div class="container">
                <div class="row">
                    <h2><font color="#663399"; size="28px">Joint Pain</font></h2>
                    ...
                    <ul>
                        ...
                        <li><i class="fas fa-angle-double-right"></i> <font size="4px">Joint Pain</font> </li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        <img src="{{asset('assets/images/facilities/Joint-pain.jpg')}}" alt="" height=510">
                        <p style="text-align:center; font-size:40px"><font color="purple"><u>Joint Pain</u></font></p>
                        ...
                        <font size="5px" ; color="#C71585">Overview</font> 
                                <p style="text-align : justify; font-size:16px;">Joint discomfort is common and usually felt in the hands, feet, hips, knees, or spine. Pain may be constant or it can come and go. Sometimes the joint can feel stiff, achy, or sore. Some patients complain of a burning, throbbing, or “grating” sensation. In addition, the joint may feel stiff in the morning but loosen up and feel better with movement and activity. However, too much activity could make the pain worse.</p>
                                 </br>
                                 <p style="text-align : justify; font-size:16px;">Joint pain may affect the function of the joint, and can limit a person’s ability to do basic tasks. Severe joint pain can affect the quality of life. Treatment should focus not only on pain but also on the affected activities and functions.   </p>
                                 </br>
                             
            <font size="5px" ; color="#C71585">What symptoms of joint pain are causes for concern? </font> 
</br>
            </br>
            <p style="text-align :justify; font-size:16px;"> Symptoms of joint pain range from mild to disabling. Without cartilage, bones rub directly against each other as the joint moves. Symptoms can include:</p>
                </br> <ol>
                     <ul>
                         <li>&nbsp&nbsp&nbsp 1. Swelling</li>
                         <li>&nbsp&nbsp&nbsp 2. Numbness</li>
                         <li>&nbsp&nbsp&nbsp 3. Painful movement</li>
                         <li>&nbsp&nbsp&nbsp 4. Loss of motion</li>
                         
                       
                     </ul>
                    </ol>    </br>

                  <font size="5px" ; color="#C71585">What causes joint pain?</font> 
                        </br>
                             </br><ol>
                     <ul>
                         <li>&nbsp&nbsp&nbsp <b>1. Osteoarthritis, :</b> <p style="text-align :justify; font-size:16px;">a common type of arthritis, happens over time when the cartilage, the protective cushion in between the bones, wears away. The joints become painful and stiff. Osteoarthritis develops slowly and usually occurs during middle age.</p> </li>
                                
                </br> <li>&nbsp&nbsp&nbsp <b>2. Rheumatoid arthritis  :</b> <p style="text-align :justify; font-size:16px;">is a chronic disease that causes swelling and pain in the joints. Often the joints become deformed (usually occurring in the fingers and wrists).</p> </li>
                             
                </br>    <li>&nbsp&nbsp&nbsp  <b>3. Bursitis  :</b> <p style="text-align :justify; font-size:16px;"> is caused by overuse. It is usually found in the hip, knee, elbow, or shoulder.</p> </li>
                              
                </br>   <li>&nbsp&nbsp&nbsp  <b>4. Tendinitis  :</b> <p style="text-align :justify; font-size:16px;">is an inflammation of the tendons, or the flexible bands that connect bone and muscle. It is typically seen in the elbow, heel, or shoulder and is usually caused by overuse.</p> </li>
